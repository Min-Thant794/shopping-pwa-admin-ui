  ...
  return (
    <div className='flex flex-col gap-3'>
      <div className='flex gap-3 items-center relative'>
        <RippleButton className='flex items-center gap-3 justify-center bg-[#383838] rounded-md w-1/7 cursor-pointer shadow-xl text-center text-amber-50 tracking-wide font-semibold px-3 py-2'>
          Create New User
      ...
      <div className="grid grid-cols-4">
        {allUsers.map((user, index) => (
          <div key={user._id || index} className="bg-[#B5BAB5] col-span-1 grid grid-cols-3 px-3 items-center gap-5 justify-center p-2 rounded-md shadow-xl shadow-black/10">
            ...
            <div>
              <RippleButton className={"w-full px-3 py-2 rounded-md cursor-pointer bg-[#383838] font-semibold tracking-wider text-amber-50"}>
                Edit
              </RippleButton>
            </div>
